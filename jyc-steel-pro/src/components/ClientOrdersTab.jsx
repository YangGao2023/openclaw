...
export default function ClientOrdersTab({ clientId, clientName }) {
  ...
  if (!clientId) {
    return <div className="text-center py-10 text-muted-foreground">请先选择一个客户</div>;
  }

  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <h3 className="font-semibold">{clientName} 的订单</h3>
